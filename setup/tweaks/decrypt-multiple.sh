#!/bin/bash
# When you have have multiple encrypted drives that you'd like to unlock
# simultaneously, you can do that by adding keyscript=decrypt_keyctl to both
# drives in /etc/crypttab
